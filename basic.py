...
#######################################
class Error:
    def __init__(self,posStart, posEnd, error_name, details):
    ...
    def as_string(self):
        ...
        r += f'File{self.pos_start.fn}, line{self.pos_start.ln + 1}'
...
class BinOpNode:
    def __init__(self, lNode, opTok, rNode):
        self.left_node = lNode
        self.op_tok = opTok
        self.right_node = rNode
...
class Parser:
    ...
    def advance(self):
        ...
        if self.tok_idx < len(self.tokens):
            # print("\nTok idx ", self.tok_idx, "\tLen: ", len(self.tokens))
            self.current_tok = self.tokens[self.tok_idx]
            # print("Current tok: ",self.current_tok)
            # self.tok_idx += 1
